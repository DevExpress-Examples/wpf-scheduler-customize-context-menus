    ...
    Public Class SportChannelsData
        Public Shared ReadOnly SportGroups() As SportGroup = { _
            New SportGroup() With { _
                .Id = 0, _
                .Caption = "SportNews", _
                .Color = Color.FromRgb(255, 255, 255) _
            }, _
            New SportGroup() With { _
                .Id = 1, _
        ...
        Public Property Events() As ObservableCollection(Of SportEvent)
            ...
            End Set
        End Property
        Private privateCancelledEvents As ObservableCollection(Of SportEvent)
        Public Property CancelledEvents() As ObservableCollection(Of SportEvent)
            Get
                Return privateCancelledEvents
            End Get
            Private Set(ByVal value As ObservableCollection(Of SportEvent))
                privateCancelledEvents = value
            End Set
        End Property
